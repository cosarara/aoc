...
def display_strat(bp, path):
    robots = {ore: 1, clay: 0, obs: 0, geo: 0}
    items = {ore: 0, clay: 0, obs: 0, geo: 0}
    time = 24
    #for t, p in path:
    #    time -= t
    #    print("turn", 24-time, "made a", p, "robot")
    #    items = {k: (v + robots[k]*t)
...
def hashable(robots, items, turns):
    return (*tuple(robots[m] for m in materials),
